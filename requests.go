...
func (h *Requests) Get(surl string) (string, int, *http.Response) {
	return h.Launch("GET", surl, "")
}

func (h *Requests) Post(surl string, post string) (string, int, *http.Response) {
	return h.Launch("POST", surl, post)
}

func (h *Requests) GetOrPost(surl string, post string) (string, int, *http.Response) {
	if post == "" {
		return h.Launch("GET", surl, "")
	} else {
		return h.Launch("POST", surl, post)
...
func (h *Requests) Options(surl string) (string, int, *http.Response) {
	return h.Launch("OPTIONS", surl, "")
}
...
func (h *Requests) LaunchNoRead(method string, surl string, post string) *http.Response {
...
func (h *Requests) Launch(method string, surl string, post string) (string, int, *http.Response) {
	req, err := http.NewRequest(method, surl, strings.NewReader(post)) // hace la resolucion dns aqui?
